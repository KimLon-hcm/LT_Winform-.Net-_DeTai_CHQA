...
namespace DOANCUATAI.GiaoDien
{
    public partial class DangNhap : Form
    {
        ...
        private void btn_DangNhap_Click(object sender, EventArgs e)
        {
            ...
            Users userResult = userObj.TimTaiKhoan(tentk);
            ...
            if (userResult != null)
            {
                ...
                {
                    string quyen = userResult.TrangThaiQuyen;
                    string manv = userResult.Manhanvien;
                    ...
                    {
                        MessageBox.Show("Đăng nhập thành công quyền Bán Hàng (SALE)!", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                    else if (quyen == "KHO")
                    {
                        MessageBox.Show("Đăng nhập thành công quyền Kho (KHO)!", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                    else
                    {
